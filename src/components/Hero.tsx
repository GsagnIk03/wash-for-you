  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        background: 'radial-gradient(circle, rgba(41,121,216,0.1) 0%, transparent 70%)',
        pointerEvents: 'none',
      }} />
      ...
      <div style={{
        ...
        <p style={{
          ...
          We harness the power of high-temperature steam to deliver a deep,
          chemical-free clean for your vehicle, saving up to 95% water compared
      ...
      <div style={{
        ...
        <div style={{
          ...
          width: '75%', height: 40,
          background: 'radial-gradient(ellipse, rgba(62,207,207,0.35) 0%, transparent 70%)',
